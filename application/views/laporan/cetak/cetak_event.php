...
<head>
	...
	<style type="text/css">
		...
		.mockup{position: relative;width: 80%;height: auto;justify-content: center;text-align: center;align-items: top;font-family:Arial, sans-serif;font-size:20px;margin: 0 auto 20px;}
...
<div class="mockup">
	...
	<table class="tg" >
	  	<tr>
		    ...
		    <th class="tg-1wig">Nama Event</th>
		    <th class="tg-1wig">Tanggal</th>
		    <th class="tg-1wig">Tempat</th>
	  	...
	  	<tr>
		    ...
		    <td class="tg-0lax"><?= $value->nama_event ?></td>
		    <td class="tg-0lax"><?= tgl_indo($value->tanggal) ?></td>
		    <td class="tg-0lax"><?= $value->tempat ?></td>
