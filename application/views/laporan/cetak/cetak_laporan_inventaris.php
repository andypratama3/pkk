...
<body onload="setTimeout(cetak,1000)">
	...
	<table class="tg">
	  	<tr>
			...
			<th class="tg-1wig">Tanggal Pinjam</th>
			<th class="tg-1wig">Tanggal Kembali</th>
	  	...
	  	<tr>
			...
			<td class="tg-0lax"><?= $value->tanggal_pinjam ?></td>
			<td class="tg-0lax"><?= $value->tanggal_kembali ?></td>
