...
<body onload="setTimeout(cetak,1000)">
	...
	<table class="tg" >
	  	<tr>
		    ...
		    <th class="tg-1wig">Jabatan</th>
		    <th class="tg-1wig">Username</th>
		    <th class="tg-1wig">Hak Akses</th>
	  	</tr>
	  	<?php
	        $no = 1;
	        foreach ($pengguna_data as $value) { ?>
	  	<tr>
		    <td class="tg-baqh"><?= $no++; ?></td>
		    <td class="tg-0lax"><?= $value->nik ?></td>
		    <td class="tg-0lax"><?= $value->nama_anggota ?></td>
		    <td class="tg-0lax"><?= $value->jabatan_anggota ?></td>
		    <td class="tg-0lax"><?= $value->username ?></td>
		    <td class="tg-0lax"><?= $value->hak_akses ?></td>
	  	</tr>
	  	<?php } ?>
	</table>
