		...
		<div class="box box-success box-solid">
			...
			<div class="box-body">
				<form style="padding: 15px;" action="<?= $action; ?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<div class="row">
							<label class="col-md-2" for="datetime">Tanggal Peminjaman <?= form_error('tanggal_pinjam') ?></label>
							<div class="col-md-6">
								<input type="text" class="form-control datetimepicker"  name="tanggal_pinjam" id="tanggal_pinjam" placeholder="tanggal_pinjam" value="<?= $tanggal_pinjam; ?>" />
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="row">
							<label class="col-md-2" for="datetime">Tanggal <?= form_error('tanggal_kembali') ?></label>
							<div class="col-md-6">
								<input type="text" class="form-control datetimepicker"  name="tanggal_kembali" id="tanggal_kembali" placeholder="tanggal_kembali" value="<?= $tanggal_kembali; ?>" />
							</div>
						</div>
					</div>
					<div class="form-group">
